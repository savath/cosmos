...
int main(int argc, char** argv)
{
    ...
    string agentname = "teensy"; //name of the agent that the request is directed to
    std::string soh;

    // if there is no arguments use default serial port
    //string serial_port = "/dev/ttyACM0";
    string serial_port = "/dev/tty.usbmodem12341";  // Serial port of Microcontroller (Arduino Uno, Teensy, etc)
